    ...
    <div className="max-w-5xl mx-auto px-6 py-16 bg-gray-900">
      <div className="flex flex-col md:flex-row md:items-start items-center gap-10 mb-12">
        ...
        <div>
          ...
          <p className="text-gray-300 text-lg">
            ...
            building friendly digital experiences and helping other grow into
      ...
      <div className="mb-12">
        ...
        <p className="text-gray-300 leading-relaxed">
          ...
          you're proud of. Through tutorials,courses, and real-world projects, I
          aim to make development accessible, friendly, and something you look
          forward to each day.
        </p>
      </div>
      <h2 className="text-2xl font-semibold text-white mb-4">🚀 Tech I Use</h2>
      <ul className="flex flex-wrap gap-4 text-sm text-gray-300">
        {["React", "Tailwind CSS", "TypeScript", "SCSS", "Redux", "Git"].map(
          (tech) => (
